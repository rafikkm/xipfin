     ...
     <div class="collapse navbar-collapse" id="main-navbar">
        ...
        <ul class="mobile-menu">
           <li>
            ...
            <li>
              <a class="page-scroll" href="jobs">Je postule en ligne</a>
            </li>
            <li>
              <a class="page-scroll" href="#features">Universités et News</a>
            </li>
            <li>
              <a class="page-scroll" href="conseil">Conseil XIP</a>
            </li>
            <li>
              <a class="page-scroll" href="entreprise">Je deviens Partenaire XIP</a>
            </li>
        </ul>
        <!-- Mobile Menu End -->
        ...
        <div id="carousel-slider" class="carousel slide carousel-fade" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img src="assets/img/steps/slider-conseil.jpg" alt="">
